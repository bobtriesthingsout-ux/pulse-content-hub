      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:px-8 md:py-12">
        <header className="mb-10">
          ...
          <p className="text-muted-foreground mt-3 text-lg">
            Configure the feeds and channels Pulse monitors for you.
          </p>
        </header>
            ...
            {sources.map((source) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground truncate font-medium mb-3">
                      {source.url}
                    </p>
                    <div className="flex items-center justify-between">
                      <Badge
                        variant="outline"
                        className={`capitalize px-2.5 py-0.5 font-medium ${typeColorMap[source.type]}`}
                      >
                        <SourceIcon
                          type={source.type}
                      ...
                      <Badge
                        variant="secondary"
                        className={`font-semibold tracking-wide uppercase text-[10px] ${isActive ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`}
                      >
          ...
          <form onSubmit={handleAddSource} className="space-y-5 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              <div className="space-y-2 sm:col-span-1">
                ...
                <Select
                  value={newType}
                  onValueChange={(v) => setNewType(v as SourceType)}
                >
